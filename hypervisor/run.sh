...
qemu-system-riscv64 -smp 4 -bios build/acrn.elf -gdb tcp::1235 -S -M virt -m 4G,slots=3,maxmem=8G -kernel ./vmlinux -initrd ./initrd -nographic
#qemu-system-riscv64 -smp 4 -bios build/acrn.elf -gdb tcp::1235 -S -serial stdio -M virt -m 4G,slots=3,maxmem=8G -kernel ./vmlinux -initrd ./initrd -nographic
